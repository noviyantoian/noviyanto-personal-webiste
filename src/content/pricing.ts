...
// Nama tier sengaja memakai istilah yang lazim dipakai orang Indonesia
// ("Landing Page", "Website Bisnis"), bukan istilah karangan. Beban menjual
// dipikul tagline dan daftar fitur — nama cukup bertugas agar orang langsung
// paham ia sedang melihat apa.
...
const WEBSITE_TIERS: readonly PricingTier[] = [
  ...
  },
  {
    ...
    tagline: 'Pilihan mayoritas bisnis yang serius',
    popular: true,
    features: [
      'Jumlah halaman menyesuaikan kebutuhan bisnis',
      'Desain dibuat khusus, bukan template',
      'Optimasi Google lengkap',
      'Terhubung Google Analytics & Search Console',
      'Konten bisa Anda ubah sendiri tanpa programmer',
      'Blog siap pakai',
      'Domain & hosting atas nama Anda',
      'Revisi besar 3×',
      'Pendampingan 30 hari setelah website tayang',
    ],
  },
  {
    slug: 'web-marketing',
    ...
    tagline: 'Website plus cara mendatangkan pengunjung',
    features: [
      'Semua yang ada di Website Bisnis',
      'Riset kata kunci & rencana isi halaman',
      'Iklan Google disiapkan sampai jalan',
      'Google Maps bisnis Anda dioptimalkan',
      'Laporan bulanan: dari mana calon klien datang',
      'Revisi tidak terbatas selama pengerjaan',
      'Pendampingan 90 hari setelah website tayang',
    ],
  },
  {
    slug: 'web-custom',
    ...
    features: [
      'Aplikasi web dengan alur kerja khusus',
      'Menyambung ke sistem yang sudah Anda pakai',
      'Dua bahasa atau banyak cabang',
      'Pindahan dari website lama',
