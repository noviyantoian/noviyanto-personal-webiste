...
import TourFAQ from './_components/TourFAQ'
    ...
    <section id="stats" className="bg-[#F9FAFB] py-14 border-y border-[#E5E7EB]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {stats.map((s) => (
            <div key={s.label}>
              <div className="font-display font-semibold text-3xl sm:text-4xl text-[#F59E0B] mb-1">
                {s.value}
              </div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {pains.map((p, i) => (
            <div
              key={i}
              className="flex gap-4 items-start p-5 rounded-xl border-l-4 border-[#EF4444] bg-[#FFF5F5] border border-[#FECACA]"
            >
    ...
    <section id="solusi" className="bg-[#FFFBEB] py-20 lg:py-28 border-y border-[#FDE68A]">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-[#6B7280] text-base sm:text-lg leading-relaxed mb-4">
          Website bukan sekadar &ldquo;brosur online&rdquo;. Setiap website yang Noviyanto bangun
          dirancang menggunakan prinsip CRO (Conversion Rate Optimization) — setiap elemen, warna,
          kata, dan posisi tombol ditempatkan secara strategis untuk mengubah pengunjung menjadi
          pelanggan nyata.
        </p>
        <p className="text-[#9CA3AF] text-sm">
          Bukan template. Bukan copy-paste. Dibangun custom, khusus untuk industri tour &amp;
          travel, sesuai target pasar dan brand Anda.
        </p>
      </div>
    </section>
  )
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {FEATURES.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="flex gap-4 p-6 rounded-2xl border border-[#E5E7EB] hover:border-[#FDE68A] hover:bg-[#FFFBEB] transition-colors duration-200"
            >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="font-display font-semibold text-3xl sm:text-4xl text-[#111827] tracking-tight mb-3">
            Proses Mudah, Hasil Profesional
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {STEPS.map((step) => (
            <div key={step.num} className="bg-white rounded-2xl border border-[#E5E7EB] p-6">
              <div className="font-display font-semibold text-4xl text-[#F59E0B]/30 mb-3 leading-none">
                {step.num}
              </div>
              <div className="inline-block px-2 py-0.5 bg-[#FFFBEB] border border-[#FDE68A] rounded-full text-[#B45309] text-xs font-medium mb-2">
                {step.time}
              </div>
  ...
  return (
    <section id="portofolio" className="bg-white py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="font-display font-semibold text-3xl sm:text-4xl text-[#111827] tracking-tight mb-3">
            Hasil Nyata untuk Bisnis Tour &amp; Travel Nyata
          </h2>
        ...
        <div className="grid sm:grid-cols-2 gap-6 mb-10">
          {PORTFOLIOS.map(({ client, result, icon: Icon }) => (
            <div
              key={client}
              className="p-6 rounded-2xl border border-[#E5E7EB] hover:border-[#FDE68A] hover:shadow-sm transition-all duration-200"
            >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {PLANS.map((plan) => (
            <div
              ...
              className={`relative rounded-2xl border p-6 bg-white ${
                plan.popular ? 'border-[#F59E0B] shadow-lg ring-1 ring-[#F59E0B]/20' : 'border-[#E5E7EB]'
              }`}
            >
              {plan.popular && (
              ...
              <a
                ...
                className={`flex items-center justify-center h-10 w-full rounded-xl text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F59E0B] focus-visible:ring-offset-2 ${
                  plan.popular
                    ? 'bg-[#F59E0B] hover:bg-[#D97706] text-[#111827]'
        ...
        <p className="mt-8 text-center text-xs text-[#9CA3AF]">
          * Semua harga belum termasuk PPN 11%. Butuh fitur custom?{' '}
          <a href={waHref} target="_blank" rel="noopener noreferrer" className="text-[#D97706] hover:underline">
...
const TESTIMONIALS = [
  {
    quote: 'Sebelumnya saya cuma andalkan Instagram dan WA. Setelah punya website dari Noviyanto, dalam 2 bulan pertama sudah dapat 40+ inquiry organik dari Google tanpa iklan berbayar. Luar biasa!',
    name: 'Pak Budi Santoso',
    role: 'Owner Bali Sunrise Tours',
  },
  {
    quote: 'Desainnya bagus, loading cepat, dan yang paling penting langsung banyak yang tanya paket tour. ROI-nya balik dalam 3 bulan! Sekarang saya tidak takut lagi bersaing dengan OTA besar.',
    name: 'Ibu Ratna Dewi',
    role: 'Director Nusantara Travel & Tour, Surabaya',
  },
  {
    quote: 'Prosesnya mudah, Noviyanto sabar banget dampingi saya yang awam soal website. Selesai tepat waktu, hasilnya melebihi ekspektasi. Highly recommended!',
    name: 'Mas Adi Kurniawan',
    role: 'CEO Explore Indonesia Tours, Yogyakarta',
  },
] as const
  ...
  return (
    <section id="cta" className="relative bg-white py-24 lg:py-32 overflow-hidden">
      <div
        ...
        aria-hidden="true"
        style={{ background: 'radial-gradient(ellipse 50% 40% at 50% 50%, rgba(245,158,11,0.10), transparent 70%)' }}
      />
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p className="text-[#6B7280] text-base sm:text-lg leading-relaxed mb-8">
          Bergabunglah dengan 50+ pemilik bisnis tour &amp; travel yang sudah mempercayakan website
          mereka kepada Noviyanto. Konsultasi pertama GRATIS — tanpa tekanan, tanpa kewajiban apapun.
        </p>
        <div className="mb-8 p-5 rounded-2xl bg-[#FFFBEB] border border-[#FDE68A] text-left">
          ...
          <ul className="space-y-1.5">
            {[
              'Setup Google Business Profile (senilai Rp 500.000) — GRATIS',
              '1 Artikel SEO Blog siap publish (senilai Rp 300.000) — GRATIS',
              'Konsultasi Strategi Digital Marketing 1 Jam (senilai Rp 500.000) — GRATIS',
            ].map((b) => (
        ...
        <p className="text-xs text-[#D97706] font-medium mb-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-7 py-3.5 border border-[#E5E7EB] hover:bg-[#F9FAFB] text-[#374151] font-medium text-base rounded-xl transition-colors"
          >
            📧 Kirim Email
          </a>
        </div>
        <p className="mt-6 text-xs text-[#9CA3AF]">
          {SITE.email} · wa.me/{SITE.waNumber}
        </p>
      </div>
    </section>
  )
    ...
    <footer id="footer" className="bg-[#F9FAFB] border-t border-[#E5E7EB] py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-[#6B7280] leading-relaxed">
              Spesialis membantu bisnis tour &amp; travel Indonesia tumbuh melalui website profesional, SEO, dan integrasi digital.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[['↑ Kembali ke Atas', '#hero'], ['Fitur', '#fitur'], ['Portofolio', '#portofolio'], ['Harga', '#harga'], ['FAQ', '#faq'], ['Konsultasi Gratis', '#cta']].map(([label, href]) => (
                <li key={href}>
                  <a href={href} className="text-sm text-[#6B7280] hover:text-[#111827] transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 mb-6">
              ...
              <li><a href={getWaLink('tourTravel')} target="_blank" rel="noopener noreferrer" className="text-sm text-[#6B7280] hover:text-[#111827]">📱 wa.me/{SITE.waNumber}</a></li>
        ...
        <div className="border-t border-[#E5E7EB] pt-6 text-center text-xs text-[#9CA3AF]">
          ...
          <br />
          Halaman ini adalah sub-layanan dari noviyanto.com
        </div>
      </div>
    </footer>
  )
